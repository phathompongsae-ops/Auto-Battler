...
// หมายเหตุ: FILL_RATIO สูงเกินไป (เช่น 0.94) แทบไม่เหลือพื้นที่ว่าง (slack) ให้ดันลงล่างได้เลย —
// ต้องเผื่อ slack ไว้พอสมควรก่อน ถึงจะมีที่ให้ดันกระดานลงไปชิดขอบล่างได้จริงตามที่ต้องการ
const BOARD_FILL_RATIO = 0.84; // กระดานกินความสูงจอ ~84% — ใหญ่ แต่เหลือ slack ~16% ให้ดันลงล่าง
